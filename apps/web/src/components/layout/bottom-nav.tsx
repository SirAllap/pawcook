  ...
  return (
    ...
    >
      <div className="pointer-events-auto glass shadow-xl rounded-[26px] overflow-hidden">
        {/* Icon-only on narrow phones; icon + label once we have room. */}
        <div className="grid grid-cols-7 h-16 sm:h-[64px] relative">
          {tabs.map(({ to, label, Icon }) => {
            ...
            return (
              ...
              >
                ...
                <span className="hidden min-[400px]:block text-[10px] font-bold leading-none truncate w-full text-center px-0.5">
                  {label}
                </span>
              </NavLink>
            );
